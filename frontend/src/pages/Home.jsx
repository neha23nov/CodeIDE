  ...
  return (
    <>
      ...
      <div className="flex items-center px-[100px] justify-between mt-5">
        {/* ✅ Fixed: dynamic username from localStorage */}
        <h3 className='text-2xl'>👋 Hi, {localStorage.getItem("name") || "User"}</h3>
      ...
      <div className="projects px-[100px] mt-5 pb-10">
        {
          projects && projects.length > 0 ? projects.map((project, index) => {
            return (
              <div key={index} className="project w-full p-[15px] flex items-center justify-between bg-[#0f0e0e]">
